<template>
  <v-container fluid class="tw-bg-[url('src/assets/bg_pokemon.png')] full-img tw-h-full">
    <v-row no-gutters class="tw-border-2 tw-border-zinc-500  tw-rounded-lg tw-bg-white pb-10">
      <v-col cols="12" class="tw-rounded-lg">
        ...
        <v-col cols="12" class="d-flex justify-center mt-6 mb-6">
          <v-row no-gutters class="flex tw-justify-around ">
            ...
            <v-col cols="7" class="tw-bg-stone-100 tw-border-2 tw-border-zinc-300 tw-rounded-lg pt-6 pb-6
            tw-font-mono tw-text-3xl tw-capitalize pl-10 tw-leading-10">
              <v-row no-gutters>
                <v-col cols="6">
              ...
              <v-row no-gutters class="">
                <v-chip class="mt-2 ml-2" size="x-large" color="gray" v-for="(item, index) in pokemon.ability"
                  v-bind:key="item.id">
              ...
              <v-row no-gutters class="">
                <v-chip class="mt-2 ml-2" size="x-large" color="gray" v-for="(item, index) in pokemon.type"
                  v-bind:key="item.id">
                  {{ pokemon.type[index] }}
                </v-chip>
