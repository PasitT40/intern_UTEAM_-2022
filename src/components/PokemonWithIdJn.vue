<template>
  <v-container>
    <v-row no-gutters justify="center" class="ma-3">
      <span class="tw-font-[800] tw-text-[50px] tw-font-mono"
        >{{ pokemon.name }} #{{ pokemon.id }}</span
      >
    </v-row>
    ...
    <v-row no-gutters>
      ...
      <v-col
        ...
        class="
          ma-5
          pa-4
          tw-font-mono tw-font-medium tw-text-[22px] tw-rounded-lg tw-bg-red-300
        "
      >
        <v-row no-gutters>
          <v-col cols="5">
            <v-row no-gutters class="tw-text-white">Height</v-row>
            <v-row no-gutters class="tw-text-[18px]">{{
              pokemon.height
            }}</v-row>
          </v-col>
          <v-col cols="5">
    ...
    <v-row no-gutters>
      <v-col cols="5" class="mt-4">
        <p no-gutters class="ma-2 tw-font-mono tw-font-medium tw-text-[22px]">
          Types
        </p>
        <span class="pa-1 tw-text-[18px] tw-bg-slate-300 tw-rounded-full">{{
          pokemon.type[0]
        }}</span>
        <span class="ma-3 pa-1 tw-text-[18px] tw-bg-pink-300 tw-rounded-full">{{
          pokemon.type[1]
        }}</span>
      </v-col>
    </v-row>
